...
export class RdUserService {
  ...
  getUserProfiles(rdCommon) {
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Profiles/getProfiles.php",
  ...
  getUserProfileDetail(rdCommon) {
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Profiles/getSingleProfile.php",
        JSON.stringify(this._encryptDecryptService.ecryptModel(rdCommon))
      )
      .pipe(
        map((res) => {
  ...
  getUserPorfolios(rdCommon) {
    ...
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Portfolios/getPortfolios.php",
        JSON.stringify(this._encryptDecryptService.ecryptModel(rdCommon))
      )
      .pipe(
        map((res) => {
  ...
  getUserEvents(rdCommon) {
    ...
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Events/getEvents.php",
        JSON.stringify(this._encryptDecryptService.ecryptModel(rdCommon))
      )
      .pipe(
        map((res) => {
  ...
  getEventDetail(rdCommon) {
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Events/getSingleEvent.php",
        JSON.stringify(this._encryptDecryptService.ecryptModel(rdCommon))
      )
      .pipe(
        map((res) => {
  ...
  UploadUserPortfolioFile(file: any, portfolioName: string) {
    ...
    formData.append(
      "UserId",
      this._encryptDecryptService.set(this.currentUserSubject.id)
    );
    formData.append(
      "Email",
      this._encryptDecryptService.set(this.currentUserSubject.username)
    );
    formData.append(
      "FirstName",
      this._encryptDecryptService.set(this.currentUserSubject.firstName)
    );
    formData.append("Type", this._encryptDecryptService.set("Portfolio"));
    formData.append(
      "PortfolioName",
      this._encryptDecryptService.set(portfolioName)
    );
    ...
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Uploads/uploadMedia.php",
        formData
      )
      .pipe(
        map((res) => {
  ...
  UploadUserRadianProfileImage(
    ...
    formData.append(
      "ProfileName",
      this._encryptDecryptService.set(profileName)
    );
  ...
  addUserProfile(rdProfile: any) {
    ...
    rdProfile.ProfilePicture =
      rdProfile.ProfilePicture === null ? "" : rdProfile.ProfilePicture;
  ...
  addUserPortfolio(rdPortfolio: any) {
    ...
    return this.http.post<any>(
      environment.apiCommon + "radianApi/Portfolios/createPortfolio.php",
      JSON.stringify(data)
    );
  }
  addUserEvent(rdEvent: any) {
    ...
    return this.http.post<any>(
      environment.apiCommon + "radianApi/Events/createEvent.php",
      JSON.stringify(data)
    );
  }
  addUpdateSettings(rdSettings: any) {
    ...
    return this.http.post<any>(
      environment.apiCommon + "radianApi/Settings/userSettings.php",
      JSON.stringify(data)
    );
  }
  searchMember(rdSearchMember: any) {
    this.currentUserSubject = this.rdAuthenticateService.getLocalStorageData();
    rdSearchMember.UserId =
      this.currentUserSubject === null ? 0 : this.currentUserSubject.id;
    rdSearchMember.Email =
      this.currentUserSubject === null ? "" : this.currentUserSubject.username;
    rdSearchMember.FirstName =
      this.currentUserSubject === null ? "" : this.currentUserSubject.firstName;

    var data = this._encryptDecryptService.ecryptModel(rdSearchMember);
    return this.http.post<any>(
      environment.apiCommon + "radianApi/Search/searchMember.php",
      JSON.stringify(data)
    );
  }
  searchRadianUpdate(rdSearchRadian: any) {
    this.currentUserSubject = this.rdAuthenticateService.getLocalStorageData();
    rdSearchRadian.UserId =
      this.currentUserSubject === null ? 0 : this.currentUserSubject.id;
    rdSearchRadian.Email =
      this.currentUserSubject === null ? "" : this.currentUserSubject.username;
    rdSearchRadian.FirstName =
      this.currentUserSubject === null ? "" : this.currentUserSubject.firstName;
    var data = this._encryptDecryptService.ecryptModel(rdSearchRadian);
    return this.http.post<any>(
      environment.apiCommon + "radianApi/Search/searchRadian.php",
      JSON.stringify(data)
    );
  }
  ...
  DeleteRequest(rdCommon, type: string) {
    ...
    if (type === "Event") {
      ...
      return this.http
        .post<any>(
          environment.apiCommon + "radianApi/Profiles/deleteUserProfile.php",
          JSON.stringify(this._encryptDecryptService.ecryptModel(rdCommon))
        )
        .pipe(
          map((res) => {
  ...
  getPortfolioDetail(rdGetPortfolio) {
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Portfolios/getSinglePortfolio.php",
  ...
  addEventParticipation(rdEvent: any) {
    var data = this._encryptDecryptService.ecryptModel(rdEvent);
    return this.http.post<any>(
      environment.apiCommon + "radianApi/Events/userEventCollaboration.php",
      JSON.stringify(data)
    );
  }
  getEventInterestedUserList(rdGetUserIntList) {
    return this.http
      .post<any>(
        environment.apiCommon + "radianApi/Events/getInterestedUsers.php",
        JSON.stringify(
          this._encryptDecryptService.ecryptModel(rdGetUserIntList)
        )
      )
      .pipe(
        map((res) => {
