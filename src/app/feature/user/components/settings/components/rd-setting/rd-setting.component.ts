...
export class RdSettingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.addSettingFormGroup = this._formBuilder.group({
      IsViewerProfileShown: [
        this.currentUser.isViewerProfileShown,
        Validators.required,
      ],
      IsRadianMemberProfileShown: [
        this.currentUser.isRadianMemberProfileShown,
        Validators.required,
      ],
      IsMailingAddressShown: [
        this.currentUser.isMailingAddressShown,
        Validators.required,
      ],
  ...
  onSubmit() {
    ...
    this.rdUserService
      .addUpdateSettings(new RdUserSetting(this.addSettingFormGroup.value))
      .subscribe((res) => {
        this.spinner.hide();
        if (res.status) {
          this.currentUser.isAddressShown =
            this.addSettingFormGroup.controls.IsAddressShown.value === true
              ? true
              : false;
          this.currentUser.isRadianMemberProfileShown =
            this.addSettingFormGroup.controls.IsRadianMemberProfileShown
              .value === true
              ? true
              : false;
          this.currentUser.isMailingAddressShown =
            this.addSettingFormGroup.controls.IsMailingAddressShown.value ===
            true
              ? true
              : false;
          this.currentUser.isViewerProfileShown =
            this.addSettingFormGroup.controls.IsViewerProfileShown.value ===
            true
              ? true
              : false;
          this.currentUser.isEmailShown =
            this.addSettingFormGroup.controls.IsEmailShown.value === true
              ? true
              : false;
